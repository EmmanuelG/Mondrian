...
#define STRING_CONFIG_H_AUTHOR "Emmanuel, Mondrian 3.0 MONO" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160, 160, 8000, 270}  // 280 pignon emaritimmodels
