...
#define STRING_CONFIG_H_AUTHOR "(Emmanuel, FoldaRap_Melzi MEGAMONDRIAN !!!)" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.3,80.3,4000,650}  // FoldaRap direct drive Nema14, M5 leadscrew (3200 M6 / 1200 PG35L / 660 miniextruder)
#define DEFAULT_MAX_FEEDRATE          {100, 100, 2, 50}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {800,800,30,1500}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
