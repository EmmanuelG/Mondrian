...
#define STRING_CONFIG_H_AUTHOR "(Emmanuel, Mondrian 2.2 Minitronics)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {162, 161, 8000, 280}  // default steps per unit for Ultimaker
